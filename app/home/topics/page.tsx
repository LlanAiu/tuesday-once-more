...
import { fetchAllTopics, fetchTopics, fetchTotalTopicPages } from '@/app/lib/data';
...
export default async function Page({ searchParams } : {
    ...
    const totalPages = await fetchTotalTopicPages();

    return (
        <div>
            <div className='mx-4 py-2 space-y-2 h-pagination'>
